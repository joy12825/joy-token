...
import (
	...
	"github.com/joy12825/gf/util/guid"
)
...
// SetHandlerResponse set the handler response object and its error.
func (r *Request) SetHandlerResponse(handlerResponse interface{}) {
	r.handlerResponse = handlerResponse
}
