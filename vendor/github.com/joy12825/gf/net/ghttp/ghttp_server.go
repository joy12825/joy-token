...
import (
	...
	"github.com/joy12825/gf/container/garray"
	...
	"github.com/joy12825/gf/net/ghttp/internal/swaggerui"
	"github.com/joy12825/gf/net/goai"
	...
	"github.com/joy12825/gf/os/gfile"
	"github.com/joy12825/gf/os/glog"
	"github.com/joy12825/gf/os/gproc"
	"github.com/joy12825/gf/os/gsession"
	"github.com/joy12825/gf/os/gtimer"
...
func (s *Server) doRouterMapDump() {
	...
	var (
		...
		headers                      = []string{
			"SERVER", "DOMAIN", "ADDRESS", "METHOD", "ROUTE", "ACTION", "HANDLER", "MIDDLEWARE",
		}
	)
	...
	if isJustDefaultServerAndDomain {
		headers = []string{"ADDRESS", "METHOD", "ROUTE", "ACTION", "HANDLER", "MIDDLEWARE"}
	}
	if len(routes) > 0 {
